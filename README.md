...
Data that cannot be downloaded from the public domain are available either (1) in the ‘data’ directory of this repository and may need to be unzipped locally, or (2) for those too large for Git LFS (2 shapefiles), files are provided in the location where our predictions (and eventually all pre-processed covariates) are stored: https://doi.org/10.5281/zenodo.8174951.
