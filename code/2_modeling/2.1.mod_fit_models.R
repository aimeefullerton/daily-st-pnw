...
# Functions
source("code/Full_region_17/0_functions/fncChoose.R")
source("code/Full_region_17/0_functions/fncFreeFlowing.R")
source("code/Full_region_17/0_functions/fncSubsetBy.R")
...
source("code/Full_region_17/0_functions/fncPlotAntecedentLag.R")
source("code/Full_region_17/0_functions/fncAntecedentAirTemp.R")
source("code/Full_region_17/0_functions/fncFitModel.R")
source("code/Full_region_17/0_functions/fncPlotConditionalEffects.R")
source("code/Full_region_17/0_functions/fncPlotResidsByCovars.R")
